...
_role2names = ["Tobi","Tony Chopper","Elric","SpeZBen","Issy"];
_role3 = "Webseite:";
_role3names = ["http://armalife-rpg.de"];
_role4 = "Teamspeak:";
_role4names = ["ts57.nitrado.net:19400"];
_role5 = "Besonderen dank";
_role5names = ["an Tonic","und alle die an der Mod gearbeitet haben"];
