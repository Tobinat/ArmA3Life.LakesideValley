...
class JL_Client_Core
        {
            tag = "jl";
            
           class cop
			{
				file = "core\just-look\cop";

			};
			class adac
			{
				file = "core\just-look\adac";
				class adacMarker {};
				class adacRequest {};
				class requestADAC {};
				class adacLights {};
			...
			class Fuelchanger
			{
				file = "core\just-look\fuelchanger";
			};
			class Paintball
			{
				file = "core\just-look\paintball";
				class tpPaintball {};
				class leavePaintball {};
				class PWarteschlangeAction {};
				class paintballNotifications {};
				class paintballWin {};
			};
			class truckjob
			{
				file = "core\just-look\truckjob";
