...
if ((getPlayerUID player) in ["76561198068135912","76561198032349954","76561198055304738"]) then { // Admin PlayerID Eintragen <--- Hier Bitte Alle Admins eintragen!
	...
	if ((getPlayerUID player) in ["76561198068135912","76561198032349954","76561198055304738"]) then { // Admin PlayerID Eintragen
        adminmenu =
        [
			["",true],
	...
	if ((getPlayerUID player) in ["76561198068135912","76561198032349954","76561198055304738"]) then { // Super Admin PlayerID Eintragen
		adminmenu =
		[
			["",true],
