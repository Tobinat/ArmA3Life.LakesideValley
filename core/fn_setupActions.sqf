...
switch (playerSide) do
{
	...
	{
		//Ausweis
		life_actions = life_actions + [player addAction["<t color='#00FF00'>Ausweis zeigen</t>",life_fnc_civShowLicense,"",1,false,true,"",' playerSide == civilian && !isNull cursorTarget && cursorTarget isKindOf "Man" && player distance cursorTarget < 3 ']];
		
	//Führerschein
		life_actions = life_actions + [player addAction["<t color='#00FF00'>Fahrlizenz zeigen</t>",life_fnc_ShowFahrerLicense,"",1,false,true,"",' playerSide == civilian && !isNull cursorTarget && cursorTarget isKindOf "Man" && player distance cursorTarget < 3 ']];
	...
	//Polizeimarke
		life_actions = life_actions + [player addAction["<t color='#00FF00'>Polizeiausweis zeigen</t>",life_fnc_copShowLicense,"",1,false,true,"",' playerSide == west && !isNull cursorTarget && cursorTarget isKindOf "Man" ']];
	...
	case independent:
	{		//Ausweis
		life_actions = life_actions + [player addAction["<t color='#00FF00'>Ärzteausweis zeigen</t>",life_fnc_medShowLicense,"",1,false,true,"",' playerSide == independent && !isNull cursorTarget && cursorTarget isKindOf "Man" ']];
