...
private["_target", "_message", "_array", "_arraynatio", "_randomnatio", "_random", "_zufallsZahl"];
...
_zufallsZahl = [16,65] call life_fnc_randomRound;
...
_message = format["<img size='10' color='#FFFFFF' image='textures\ausweis.paa'/><br/><br/><t size='2.5'>%1</t><br/><t size='1'>Alter: %4</t><br/><t size='1'>Nationalität: %3</t><br/><t size='1'>Heimat: %2</t>", name player, _random, _randomnatio, _zufallsZahl];
