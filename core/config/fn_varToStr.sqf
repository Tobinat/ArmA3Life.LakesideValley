...
switch (_var) do
{
	...
	case "life_inv_cone": {(localize "STR_Item_Cone")};
	case "life_inv_burger": {(localize "STR_Item_Burger")};
	case "life_inv_koke": {(localize "STR_Item_Koke")};
	case "life_inv_fries": {(localize "STR_Item_Fries")};
	case "life_inv_potato": {(localize "STR_Item_Potato")};
	case "life_inv_smallLeft": {(localize "STR_Item_smallLeft")};
	case "life_inv_smallRight": {(localize "STR_Item_smallRight")};
	case "life_inv_pole": {(localize "STR_Item_Pole")};
	case "life_inv_light": {(localize "STR_Item_Light")};
	case "life_inv_bigLeft": {(localize "STR_Item_bigLeft")};
	case "life_inv_bigRight": {(localize "STR_Item_bigRight")};
	...
	case "license_civ_donator1": {(localize "STR_License_Donator1")};
	case "license_civ_rifle": {(localize "STR_License_rifle")};
};
