...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "koke": {"life_inv_koke"};
			case "fries": {"life_inv_fries"};	
			case "smallRight": {"life_inv_smallRight"};
			case "smallLeft": {"life_inv_smallLeft"};
			case "pole": {"life_inv_pole"};
			case "light": {"life_inv_light"};
			case "bigLeft": {"life_inv_bigLeft"};
			case "bigRight": {"life_inv_bigRight"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_koke": {"koke"};
			case "life_inv_fries": {"fries"};	
			case "life_inv_smallRight": {"smallRight"};
			case "life_inv_smallLeft": {"smallLeft"};
			case "life_inv_pole": {"pole"};
			case "life_inv_light": {"light"};
			case "life_inv_bigLeft": {"bigLeft"};
			case "life_inv_bigRight": {"bigRight"};
