...
life_cone = ObjNull;
life_smallLeft = ObjNull;
life_smallRight = ObjNull;
life_pole = ObjNull;
life_light = ObjNull;
life_bigLeft = ObjNull;
life_bigRight = ObjNull;
...
__CONST__(life_revive_fee,375); //Fee for players to pay when revived.
...
__CONST__(life_impound_boat,3500);
...
//[shortVar,reward]
life_illegal_items = [["cannabis seed",500],["opium seed",500],["heroinu",1200],["heroinp",2500],["cocaine",1500],["cocainep",3500],["marijuana",2000],["turtle",3000],["blastingcharge",10000],["boltcutter",500]];
