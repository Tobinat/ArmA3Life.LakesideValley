...
_rip = true;
_kassa = 1000 + round(random 15000);
_shop removeAction _action;
_shop switchMove "AmovPercMstpSsurWnonDnon";
_chance = random(1);
if(_chance >= 1) then { hint "Die Polizei wurde benachrichtig!"; [[1,format["Ein Geldautomat wird aufgebrochen!", _shop]],"life_fnc_broadcast",west,false] spawn life_fnc_MP; };
...
sleep 300;
_action = _shop addAction["Geldautomat sprengen",life_fnc_robATM]; 
_shop switchMove "";