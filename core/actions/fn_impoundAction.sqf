...
//if(side player == civilian && !life_adac_impound && !(typeOf _vehicle in ["C_Rubberboat","C_Boat_Civil_01_F","B_SDV_01_F","O_Heli_Light_02_unarmed_F","B_Heli_Light_01_F","I_Heli_Transport_02_F","I_Truck_02_transport_F","I_Truck_02_covered_F","B_Truck_01_transport_F","B_Truck_01_covered_F","O_Truck_03_transport_F","O_Truck_03_covered_F","B_Truck_01_box_F","O_Truck_03_device_F"]))  exitWith {hint "Du musst auf den ADAC Platz sein um das Auto Einzuparken";};
...
if((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship")) then
{
	...
	if(side player == civilian) then {
		[[0,format[localize "STR_NOTF_BeingImpoundedADAC",(_vehicleData select 0) select 1,_vehicleName]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	}else{
