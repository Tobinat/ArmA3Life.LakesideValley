...
[] spawn life_fnc_fuelchanger;
[] spawn life_fnc_cleanFuelStation;
...
[] execVM "core\vehicle\fn_addKey.sqf";///here

__CONST__(life_paycheck,life_paycheck); //Make the paycheck static.
_handle = [] spawn compile PreprocessFileLineNumbers "core\just-look\init.sqf";
diag_log "::just-look Client:: Initialization";
waitUntil {scriptDone _handle};
diag_log "::just-look Client:: initialized";
