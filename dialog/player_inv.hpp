...
class playerSettings {
	...
	class RscPicture_1200: life_RscPicture
		{
			idc = 1200;
			text = "\A3L_Client2\tablet_new\playerinfo.paa";
	...
	class controls {
		...
		class moneyDrop : Life_RscButtonSilent
		{
			idc = 2001;
		...
		class removemoney: Life_RscButtonSilent
		{
			idc = 1804;
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
			x = 0.329688 * safezoneW + safezoneX;
			...
			w = 0.100104 * safezoneW;
			h = 0.0272223 * safezoneH;
			onButtonClick = "hint ""error 404; drop not found""";
